...
### Send 1000 MXT to New Addresses

Send exactly 1000 MXT to each new address created above.
...
Copy the masternode private key and correspondig collateral output transaction that holds the 1000 MXT.

*Note: The masternode priviate key is **not** the same as a wallet private key. **Never** put your wallet private key in the masternode.conf file. That is almost equivalent to putting your 1000 MXT on the remote server and defeats the purpose of a hot/cold setup.*
...
and comparing with the official explorer at https://explorer.martexcoin.org/chain/MarteX
...
```
martex-cli masternode status
{
    "outpoint" : "<collateral_output>-<collateral_output_index>",
    "service" : "<ipaddress>:<port>",
    "pubkey" : "<1000 MXT address>",
...
Search your Masternodes on https://martexninja.pl/masternodes.html
