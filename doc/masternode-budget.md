...
Format: ```mngovernance prepare proposal-name url payment-count block-start martex-address monthly-payment-mxt```
...
Format: ```mngovernance submit proposal-name url payment-count block-start martex-address monthly-payment-mxt fee-tx```
