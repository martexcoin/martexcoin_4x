...
The first step is running MarteX Core behind a Tor proxy. This will already make all
...
port 9050 and only allows .onion nodes to connect:
	...
	./martexd -onion=127.0.0.1:9050 -onlynet=tor -listen=0 -addnode=ssapp53tmftyjmjb.onion
...
your martexd's P2P listen port (9999 by default).
	...
	-externalip=X   You can tell MarteX Core about its publicly reachable address using
	                ...
	                /var/lib/tor/martexcore-service/hostname. Onion addresses are given
...
In a typical situation, where you're only reachable via Tor, this should suffice:
	...
	./martexd -proxy=127.0.0.1:9050 -externalip=ssapp53tmftyjmjb.onion -listen
...
for normal IPv4/IPv6 communication, use:
	...
	./martexd -onion=127.0.0.1:9050 -externalip=ssapp53tmftyjmjb.onion -discover


3. List of known MarteX Core Tor relays
------------------------------------
...
configured. For cookie authentication the user running martexd must have write access 
