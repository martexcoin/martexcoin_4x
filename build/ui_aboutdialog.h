...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About MartexCoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>MartexCoin</b> version", 0));
        copyrightLabel->setText(QApplication::translate("AboutDialog", "Copyright \302\251 2014 The MartexCoin developers", 0));
