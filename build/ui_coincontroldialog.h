...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 MXT"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 MXT"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 MXT"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 MXT"));
