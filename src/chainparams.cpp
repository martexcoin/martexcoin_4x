...
public:
    CMainParams() {
            ...
            consensus.nSubsidyHalvingInterval = 1051200; // Note: actual number of blocks per calendar year with DGW v3 is ~200700 (for example 449750 - 249050)
            ...
            consensus.nBudgetPaymentsCycleBlocks = 21800; // ~(60*24*30)/2.6, actual number of blocks per month is 200700 / 12 = 16725
            consensus.nBudgetPaymentsWindowBlocks = 100;
            consensus.nSuperblockStartBlock = 1715000; // The block at which 12.1 goes live (end of final 12.0 budget cycle)
            consensus.nSuperblockCycle = 21800; // ~(60*24*30)/2.6, actual number of blocks per month is 200700 / 12 = 16725
            ...
            consensus.nPowTargetTimespan = 10 * 60; // martex: 10 minutes
            consensus.nPowTargetSpacing = 2 * 60; // martex: 2 minutes
            ...
            // POS hard fork date
            consensus.nLastPoWBlock = 1950000;
            ...
            checkpointData = (CCheckpointData) {
       		...
       		(   130, uint256S("0x07039a3fa8f280011da0a5639380519e2d7f242900ac89ac9c541976bd093854"))
       		(   131, uint256S("0x5bbd19d8bdac9bb2bc6447f17faadd35ceb824f1a794116f6dad303a77fee3b7"))
		(   893, uint256S("0xb5b4971d156abd680ea20d8c3f8cacec48f91f72b22eec3fe2b19fa199995fc0"))
      		...
      		( 10486, uint256S("0x674a6933c83330b3031a1e25a4ac51ccbc6025c78a2765a724917bc0d6fa32c9"))
       		...
       		(1905311, uint256S("0x2fa08d83c4f77d00a0e83d3da2d513ea1539b797ede17235df755c70e42a524d"))
...
public:
    CTestNetParams() {
            ...
            consensus.nPowTargetTimespan = 10 * 60; // martex: 1 day
            consensus.nPowTargetSpacing = 2 * 60; // martex: 2 minutes
            ...
            consensus.nStakeMaxAge = 60 * 60 * 24; // one day
            consensus.nLastPoWBlock = 237133;
            nMinStakeInput = 1.1 * COIN;  /* min stake amount */
            ...
            //vSeeds.push_back(CDNSSeedData("testnet.martexcoin.org", "testnet.martexcoin.org"));
            //vSeeds.push_back(CDNSSeedData("testnet1.martexcoin.org", "testnet1.martexcoin.org"));
            ...
            checkpointData = (CCheckpointData) {
                    ...
                    ( 237134, uint256S("0x832300885d4864fbdf29013c8ee09c9049c99221c37fc2384ae59e2d46defffe"))
...
public:
    CDevNetParams() {
            ...
            vFixedSeeds.clear();
            vSeeds.clear();
            //vSeeds.push_back(CDNSSeedData("martexevo.org",  "devnet-seed.martexevo.org"));
...
public:
    CRegTestParams() {
            ...
            consensus.nPowTargetTimespan = 24 * 60 * 60; // martex: 1 day
            consensus.nPowTargetSpacing = 120; // martex: 2.5 minutes
            consensus.fPowAllowMinDifficultyBlocks = true;
