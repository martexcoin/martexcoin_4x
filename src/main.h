...
#define START_MASTERNODE_PAYMENTS 1497139200 // Junho 11, 2017, 00:00:00 GMT
...
static const uint256 hashGenesisBlock("0x81f998298dc023c13c9b7948f75cd1ab90b30d7f9d753e7dbdbfb3b00b193e3b");
...
public:
    ...
    {
        // MartexCoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // MartexCoin: get transaction coin age
...
public:
    ...
    // MartexCoin: two types of block: proof-of-work or proof-of-stake
    ...
    // MartexCoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // MartexCoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // MartexCoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // MartexCoin: block index flags
    enum  
    {
