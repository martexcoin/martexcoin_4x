    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        setWindowTitle(tr("AnonSend information"));

        ui->aboutMessage->setTextFormat(Qt::RichText);
        ui->scrollArea->setVerticalScrollBarPolicy(Qt::ScrollBarAsNeeded);
        ui->aboutMessage->setText(tr("\
<h3>AnonSend Basics</h3> \
AnonSend gives you true financial privacy by obscuring the origins of your funds. \
All the MarteX in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
AnonSend uses an innovative process to mix your inputs with the inputs of two other people, without having your coins ever leave your wallet. \
You retain control of your money at all times.<hr> \
<b>The AnonSend process works like this:</b>\
<ol type=\"1\"> \
<li>AnonSend begins by breaking your transaction inputs down into standard denominations. \
These denominations are 0.01 MXT, 0.1 MXT, 1 MXT and 10 MXT -- sort of like the paper money you use every day.</li> \
...
Each time the process is completed, it's called a \"round.\" Each round of AnonSend makes it exponentially more difficult to determine where your funds originated.</li> \
