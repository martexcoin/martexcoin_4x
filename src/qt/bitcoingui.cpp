...
void BitcoinGUI::createActions()
{
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible MarteX command-line options").arg(tr(PACKAGE_NAME)));

    showAnonSendHelpAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&AnonSend information"), this);
    showAnonSendHelpAction->setMenuRole(QAction::NoRole);
    showAnonSendHelpAction->setStatusTip(tr("Show the AnonSend basic information"));
    ...
    connect(showAnonSendHelpAction, SIGNAL(triggered()), this, SLOT(showAnonSendHelpClicked()));
...
void BitcoinGUI::createMenuBar()
{
    ...
    help->addAction(showAnonSendHelpAction);
    help->addSeparator();
...
void BitcoinGUI::showAnonSendHelpClicked()
{
    if(!clientModel)
        return;
