...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("MXT");
    case mBTC: return QString("mMXT");
    case uBTC: return QString::fromUtf8("μMXT");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("MarteXs");
    case mBTC: return QString("Milli-MarteXs (1 / 1,000)");
    case uBTC: return QString("Micro-MarteXs (1 / 1,000,000)");
    default: return QString("???");
    }
}
