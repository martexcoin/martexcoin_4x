...
public:
    ...
    bool IsTransactionValid(const CTransaction& txNew, const CAmount blockReward) const;
...
public:
    ...
    bool IsTransactionValid(const CTransaction& txNew, int nBlockHeight, const CAmount blockReward) const;
