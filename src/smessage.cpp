...
// Copyright (c) 2014 The MartexCoin developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("martexcoin-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("martexcoin-smsg-pow"); // Make this thread recognisable
