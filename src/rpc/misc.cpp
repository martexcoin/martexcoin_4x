...
UniValue getinfo(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 0)
        throw std::runtime_error(
            ...
            "  \"anonsend_balance\": xxxxxx, (numeric) the anonymized martex balance of the wallet\n"
...
UniValue debug(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "martex|anonsend|fastsend|masternode|spork|keepass|mnpayments|gobject )\n"
            "Change debug category on the fly. Specify single category or use '+' to specify many.\n"
            "\nExamples:\n"
            + HelpExampleCli("debug", "martex")
            + HelpExampleRpc("debug", "martex+net")
        );
    ...
    if (request.fHelp || request.params.size() != 2) {
        ...
        if(sporkManager.UpdateSpork(nSporkID, nValue, *g_connman)){
            ...
            throw std::runtime_error(
                ...
                "\nExamples:\n"
                + HelpExampleCli("spork", "SPORK_2_FASTSEND_ENABLED 4070908800")
                + HelpExampleRpc("spork", "\"SPORK_2_FASTSEND_ENABLED\", 4070908800"));
        }
    }
...
UniValue validateaddress(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"     (string, required) The MarteX address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,       (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"address\", (string) The MarteX address validated\n"
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("validateaddress", "\"MHqNjNs6VWkUDXA7fj8HuCzBzECNqhzFkr\"")
            + HelpExampleRpc("validateaddress", "\"MHqNjNs6VWkUDXA7fj8HuCzBzECNqhzFkr\"")
        );
...
UniValue verifymessage(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 3)
        throw std::runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"         (string, required) The MarteX address to use for the signature.\n"
            ...
            "\nAs json rpc\n"
            + HelpExampleRpc("verifymessage", "\"MHqNjNs6VWkUDXA7fj8HuCzBzECNqhzFkr\", \"signature\", \"my message\"")
        );
...
UniValue getaddressmempool(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "    \"satoshis\"  (number) The difference of valverde\n"
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressmempool", "'{\"addresses\": [\"MHqNjNs6VWkUDXA7fj8HuCzBzECNqhzFkr\"]}'")
            + HelpExampleRpc("getaddressmempool", "{\"addresses\": [\"MHqNjNs6VWkUDXA7fj8HuCzBzECNqhzFkr\"]}")
        );
...
UniValue getaddressutxos(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "    \"satoshis\"  (number) The number of valverde of the output\n"
            "    \"height\"  (number) The block height\n"
            "  }\n"
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressutxos", "'{\"addresses\": [\"MHqNjNs6VWkUDXA7fj8HuCzBzECNqhzFkr\"]}'")
            + HelpExampleRpc("getaddressutxos", "{\"addresses\": [\"MHqNjNs6VWkUDXA7fj8HuCzBzECNqhzFkr\"]}")
        );
...
UniValue getaddressdeltas(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1 || !request.params[0].isObject())
        throw std::runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressdeltas", "'{\"addresses\": [\"MHqNjNs6VWkUDXA7fj8HuCzBzECNqhzFkr\"]}'")
            + HelpExampleRpc("getaddressdeltas", "{\"addresses\": [\"MHqNjNs6VWkUDXA7fj8HuCzBzECNqhzFkr\"]}")
        );
...
UniValue getaddressbalance(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nResult:\n"
            "{\n"
            "  \"balance\"  (string) The current balance in valverde\n"
            "  \"received\"  (string) The total number of valverde received (including change)\n"
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressbalance", "'{\"addresses\": [\"MHqNjNs6VWkUDXA7fj8HuCzBzECNqhzFkr\"]}'")
            + HelpExampleRpc("getaddressbalance", "{\"addresses\": [\"MHqNjNs6VWkUDXA7fj8HuCzBzECNqhzFkr\"]}")
        );
...
UniValue getaddresstxids(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddresstxids", "'{\"addresses\": [\"MHqNjNs6VWkUDXA7fj8HuCzBzECNqhzFkr\"]}'")
            + HelpExampleRpc("getaddresstxids", "{\"addresses\": [\"MHqNjNs6VWkUDXA7fj8HuCzBzECNqhzFkr\"]}")
        );
...
{ //  category              name                      actor (function)         okSafeMode
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    /* MarteX features */
    { "MarteX",               "mnsync",                 &mnsync,                 true,  {} },
    { "MarteX",               "spork",                  &spork,                  true,  {"value"} },
