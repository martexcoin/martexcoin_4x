...
std::string EntryDescriptionString()
{
    return "    \"size\" : n,                 (numeric) transaction size in bytes\n"
           ...
           "       ... ],\n"
           "    \"fastsend\" : true|false, (boolean) True if this transaction was sent as an FastSend one\n"
           "    \"instantlock\" : true|false  (boolean) True if this transaction was locked via FastSend\n";
}
...
void entryToJSON(UniValue &info, const CTxMemPoolEntry &e)
{
    ...
    info.push_back(Pair("fastsend", fastsend.HasTxLockRequest(tx.GetHash())));
    info.push_back(Pair("instantlock", fastsend.IsLockedFastSendTransaction(tx.GetHash())));
}
