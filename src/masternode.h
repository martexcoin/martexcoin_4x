...
static const int MASTERNODE_COLLATERAL                  = 5000;
...
//
// The Masternode Class. For managing the Anonsend process. It contains the input of the 5000MXT, signature to prove
