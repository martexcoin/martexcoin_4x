...
bool found_3021, found_3022, found_3001, found_300, found_3031, found_3032, found_3033, found_304, found_3041, found_3042, found_3051, found_3061;
...
bool static ProcessMessage(CNode* pfrom, const std::string& strCommand, CDataStream& vRecv, int64_t nTimeReceived, const CChainParams& chainparams, CConnman& connman, const std::atomic<bool>& interruptMsgProc)
{
    ...
    else if (strCommand == NetMsgType::VERSION)
    {
        ...
        if (found_300 || found_3001 || found_3021 || found_3022 || found_3031 || found_3032 || found_3033 || found_304 || found_3041 || found_3042 || found_3051 || found_3061)
        {
            version_old = "< 4.0.0.0";
