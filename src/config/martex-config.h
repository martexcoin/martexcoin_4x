/* src/config/martex-config.h.  Generated from martex-config.h.in by configure.  */
/* src/config/martex-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef MARTEX_CONFIG_H

#define MARTEX_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The MarteX Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "MarteX Core"
...
#define PACKAGE_BUGREPORT "https://github.com/martexcoin/martexcoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "MarteX Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "MarteX Core 3.0.0"
