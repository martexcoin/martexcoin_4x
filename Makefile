...
pkgdatadir = $(datadir)/martexcore
pkgincludedir = $(includedir)/martexcore
pkglibdir = $(libdir)/martexcore
pkglibexecdir = $(libexecdir)/martexcore
...
CONFIG_CLEAN_FILES = libmartexconsensus.pc share/setup.nsi \
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	$(srcdir)/libmartexconsensus.pc.in \
...
ACLOCAL = ${SHELL} /media/programas/martexcoin_gitlab/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /media/programas/martexcoin_gitlab/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /media/programas/martexcoin_gitlab/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /media/programas/martexcoin_gitlab/build-aux/missing automake-1.15
AWK = gawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
...
COPYRIGHT_HOLDERS_FINAL = The MarteX Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = MarteX Core
COPYRIGHT_YEAR = 2019
CPP = gcc -E
...
MAINT = 
MAKEINFO = ${SHELL} /media/programas/martexcoin_gitlab/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = martexcore
PACKAGE_BUGREPORT = https://github.com/martexcoin/martexcoin/issues
PACKAGE_NAME = MarteX Core
PACKAGE_STRING = MarteX Core 3.0.0
PACKAGE_TARNAME = martexcore
PACKAGE_URL = https://martexcoin.org/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /media/programas/martexcoin_gitlab
abs_srcdir = /media/programas/martexcoin_gitlab
abs_top_builddir = /media/programas/martexcoin_gitlab
abs_top_srcdir = /media/programas/martexcoin_gitlab
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /media/programas/martexcoin_gitlab/build-aux/install-sh
...
pkgconfig_DATA = libmartexconsensus.pc
...
DIST_CONTRIB = $(top_srcdir)/contrib/martex-cli.bash-completion \
	       $(top_srcdir)/contrib/martex-tx.bash-completion \
	       $(top_srcdir)/contrib/martexd.bash-completion \
...
libmartexconsensus.pc: $(top_builddir)/config.status $(srcdir)/libmartexconsensus.pc.in
...
#rpc_test.info: test_martex_filtered.info
...
#total_coverage.info: baseline_filtered_combined.info test_martex_filtered.info rpc_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_martex_filtered.info -a rpc_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt
...
clean-local:
	rm -rf coverage_percent.txt test_martex.coverage/ total.coverage/ qa/tmp/ cache/ $(OSX_APP)
