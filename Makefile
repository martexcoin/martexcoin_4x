...
# Generated by qmake (2.01a) (Qt 4.8.7) on: Fri Feb 12 18:03:23 2016
# Project:  MartexCoin-qt.pro
# Template: app
# Command: /usr/bin/qmake USE_UPNP=- -o Makefile MartexCoin-qt.pro
#############################################################################
...
INCPATH       = -I/usr/lib64/qt/mkspecs/linux-g++ -I/usr/lib64/qt/include/QtCore -I/usr/lib64/qt/include/QtGui -I/usr/lib64/qt/include -Isrc -Isrc/json -Isrc/qt -Isrc/leveldb/include -Isrc/leveldb/helpers -Ibuild -Ibuild
LINK          = g++
LFLAGS        = -fstack-protector-all --param ssp-buffer-size=1 -Wl,-O1 -Wl,-rpath,/usr/lib64/qt/lib
LIBS          = $(SUBLIBS)  -L/usr/lib64/qt/lib /root/martexcoin/src/leveldb/libleveldb.a /root/martexcoin/src/leveldb/libmemenv.a -lrt -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lQtGui -L/usr/lib64/qt/lib -L/usr/X11R6/lib -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
Makefile: MartexCoin-qt.pro  /usr/lib64/qt/mkspecs/linux-g++/qmake.conf /usr/lib64/qt/mkspecs/common/unix.conf \
	...
	$(QMAKE) USE_UPNP=- -o Makefile MartexCoin-qt.pro
...
/root/martexcoin/src/leveldb/libleveldb.a: FORCE
	cd /root/martexcoin/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-fpermissive -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/root/martexcoin/build/build.h: FORCE
	cd /root/martexcoin; /bin/sh share/genbuild.sh /root/martexcoin/build/build.h
