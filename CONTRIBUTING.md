...
First, in terms of structure, there is no particular concept of "MarteXcoin Core
...
Before you start contributing, familiarize yourself with the MarteXcoin Core build
system and tests. Refer to the documentation in the repository on how to build
MarteXcoin Core and how to run the unit tests, functional tests, and fuzz tests.

There are many open issues of varying difficulty waiting to be fixed.
If you're looking for somewhere to start contributing, check out the
[good first issue](https://github.com/martexcoin/martexcoin/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list or changes that are
[up for grabs](https://github.com/martexcoin/martexcoin/issues?utf8=%E2%9C%93&q=label%3A%22Up+for+grabs%22).
...
The developer
[mailing list](https://groups.google.com/d/forum/martexcoin-developers-and-mips)
...
example: `refs #42` or `fixes #41`. Using the `fixes` or `closes` keywords
...
fork of MarteXcoin Core copies the merge. Instead, make any username mentions in a
...
The following applies to code changes to the MarteX Core project (and related
projects such as libsecp256k1), and is not to be confused with overall MarteX
...
Patches that change MarteXcoin consensus rules are considerably more involved than
...
The project leader is the release manager for each MarteXcoin Core release.
