# Linearize
Construct a linear, no-fork, best version of the MarteX blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install x13_hash

https://github.com/martexcoin/x13-hash
...
JSON-RPC server. Running `martexd` or `martex-qt -server` will be sufficient.
...
* `input`: martexd blocks/ directory containing blkNNNNN.dat
