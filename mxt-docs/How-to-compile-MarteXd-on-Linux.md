...
(Optional if you have a computer with enough RAM memory, you does not have to do this step.
...
2) The release is built with GCC and then "strip MarteXd" to strip the debug
