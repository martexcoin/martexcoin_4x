...
| Field Size | Field Name | Data type | Description |
| ---------- | ----------- | --------- | ---------- |
| 36 | outpoint | [COutPoint](#coutpoint) | The unspent output which is holding 5000 MXT
| # | addr | [CService](#cservice) | IPv4 address of the masternode
| 33-65 | pubKeyCollateralAddress | [CPubKey](#cpubkey) | CPubKey of the main 5000 MXT unspent output
...
| 4 | nDaemonVersion | uint32_t | The version of martexd of the masternode which is signing the message (i.e. CLIENT_VERSION)
...
| ---------- | ---------- | ----------- | ----------- |
| 10001 | 2 | FASTSEND_ENABLED | Turns on and off FastSend network wide
| 10002 | 3 | FASTSEND_BLOCK_FILTERING | Turns on and off FastSend block filtering
| 10004 | 5 | FASTSEND_MAX_VALUE | Controls the max value for an FastSend transaction (currently 2000 mxt)
| 10005 | 6 | NEW_SIGS | Turns on and off new signature format for MarteX-specific messages
| 10007 | 8 | MASTERNODE_PAYMENT_ENFORCEMENT | Requires masternodes to be paid by miners when blocks are processed
| 10008 | 9 | SUPERBLOCKS_ENABLED | Superblocks are enabled (the 10% comes to fund the mxt treasury)
...
| Field Size | Field Name | Data type | Description |
| ---------- | ----------- | --------- | ---------- |
| 36 | masternodeOutpoint1 | [COutPoint](#coutpoint) | The unspent output which is holding 5000 MXT for masternode 1
| 36 | masternodeOutpoint2 | [COutPoint](#coutpoint) | The unspent output which is holding 5000 MXT for masternode 2
...
| Field Size | Field Name | Data type | Description |
| ---------- | ----------- | --------- | ---------- |
| 36 | masternodeOutpoint | [COutPoint](#coutpoint) | The unspent output which is holding 5000 MXT
